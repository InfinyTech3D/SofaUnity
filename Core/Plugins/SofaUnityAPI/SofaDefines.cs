...
namespace SofaUnityAPI
{
    static public class SofaDefines
    {
        ...
        static public Dictionary<int, string> msg_error = new Dictionary<int, string>
        {
            ...
            {-9999, "-9999: License initialization failed at step 1."},
            {-9998, "-9998: License initialization failed at step 2."},
            {-9997, "-9997: licence limit exceeded."},
            {-9996, "-9996: licence limit reached."},
            {-9995, "-9995: License initialization failed at step 3."},

            {-9994, "-9994: License file not found."},
            {-9993, "-9993: License file content error."},
            {-9992, "-9992: licence installation limit exceeded."},
            {-9991, "-9991: licence MAC address error."},
