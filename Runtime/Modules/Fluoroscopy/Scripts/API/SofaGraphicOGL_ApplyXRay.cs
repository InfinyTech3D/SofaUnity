...
namespace SofaUnityAPI
{
    public class SofaGraphicOGL_ApplyXRay : AbtractSofaGraphicCall
    {
        ...
        protected override bool checkGraphicsDeviceType()
        {
            ...
            {
                Debug.LogError("SofaGraphicCall - The current Graphics device type does not support XRay rendering.");
                return false;
            }
        ...
        protected override int InitCall()
        {
            ...
            if (plane_XRay != null)
            {
                ...
                int renderID = SofaUnityAPI.SofaGraphicAPI.AddRenderEvent_SetVirtualXRayTexture(m_sofaContext.GetSimuContext(),
                    m_tex2D_XRay.GetNativeTexturePtr(), m_tex2D_XRay.width, m_tex2D_XRay.height, SofaPath, ((int)SystemInfo.graphicsDeviceType));
