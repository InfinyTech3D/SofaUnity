...
////// Specular:
                ...
                float3 indirectSpecular = (gi.indirect.specular + (lerp( EnvironmentReflection( viewReflectDirection , _CubemapGlossiness ), (_CubemapBaseColor.rgb*_CubemapCustomCubemap_var.rgb), _CubemapUseCustomCubemap )*_CubemapCustomCubemap_var.a*_CubemapStrength*pow(1.0-max(0,dot(normalDirection, viewDirection)),_CubemapFresnel)*8.0));
