...
namespace SofaUnity
{
    ...
    public class XRayControllerEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            model.m_initFromSOFA = EditorGUILayout.Toggle("Init from SOFA", model.m_initFromSOFA);
            ...
            model.TargetDistance = EditorGUILayout.Slider("Target distance", model.TargetDistance, 0.0f, 100.0f);
